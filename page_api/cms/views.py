...
from forms import CMSLoginForm,SettingsForm,ResetEmailForm,ResetpwdForm,\
                TagForm,AddTagForm,AddArticleForm,EditArticleForm,\
                DeleteArticleForm,TopArticleForm,CategoryForm,AddCategoryForm,\
                EditCategoryForm,DeleteCommentForm
...
# from page_api.common.views import qiniu_token as cms_qiniu_token
...
def cms_comment_list(request, page=1):
    ...
    return render(request, 'cms_comment_list.html',context=context)
