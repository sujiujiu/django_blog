...
from common.views import add_article as cms_add_article, \
						edit_article as cms_edit_article, \
						reset_email as cms_reset_email,\
						qiniu_token as cms_qiniu_token,
...
# 修改邮箱
@login_required
cms_reset_email(front_or_cms='cms')
...
# 添加文章
@login_required
cms_add_article(front_or_cms='cms'):


# 编辑文章
@login_required
cms_edit_article(front_or_cms='cms')
